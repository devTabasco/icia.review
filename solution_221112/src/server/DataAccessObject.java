...
//			"[TODO.txt 파일 경로]" 
			"D:\\changyong\\java\\solution_221105\\src\\database\\MEMBERS.txt",
			"D:\\changyong\\java\\solution_221105\\src\\database\\ACCESSHISTORY.txt",
			"D:\\changyong\\java\\solution_221105\\src\\database\\TODO.txt"
	};
	...
	public ArrayList<TodoBean> getList(TodoBean searchInfo) {
		...
		try {
			...
			while ((line = reader.readLine()) != null) {
				...
				/* [코드 작성 구역 4]
				 * reader를 통해 읽어온 TODO.txt Data에서 우리는 사용하지 않는 데이터는
				 * continue를 통해 제외해주려고 합니다.
				 * 그 중에서 searchInfo에 담긴 내 AccessCode가 아닌 데이터를 continue하는 코드를 작성해보세요.
				 * 
